 ...
 * just like a Lucide icon and it'll size correctly.
 */
const CLAUDE_PATH =
...
export function ClaudeIcon({
  ...
  // Inline the path so width/height classes (h-4 w-4, h-5 w-5, etc.) work the
  // same way they do for Lucide icons. The path is identical in both bundled
  // SVGs; only the fill differs.
  return (
    <svg
      viewBox="0 0 24 24"
...
/**
 * Larger brand-mark version that uses the file in /public — for hero contexts
 * where we want next/image's optimization and don't need icon-style sizing.
 */
