...
const EXPERIENCE_PREDICATE_RE =
  /\b(?:watched|saw|seen|noticed|observed|worked|spent|built|ran|started|founded|launched|sold|bought|grew|generated|earned|lost|hired|fired|managed|led|helped|coached|advised|met|spoke|learned|discovered|tested|used|tried|made|created)\b/gi;
