...
//     fast, deterministic checks that the detectors themselves are correct,
...
//     and
//   • the check_draft MCP tool, which lets an external agent hold its own draft
//     to this same bar before saving it.
//
// This module lives in lib/ rather than evals/ BECAUSE of that third caller:
// shipped code cannot import from the eval tree, so while these detectors sat
// there they were a well-tested asset no runtime path could reach.
//
