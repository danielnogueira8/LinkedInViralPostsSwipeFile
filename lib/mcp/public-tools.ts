...
export const PUBLIC_MCP_TOOLS = [
  { name: "search_viral_posts", description: "Search viral posts with niche, date, engagement, and format filters.", group: "Research", access: "Read" },
  { name: "get_post", description: "Read one tracked viral post by its id.", group: "Research", access: "Read" },
