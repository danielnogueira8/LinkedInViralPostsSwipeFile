    ...
    <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[180px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full">
      <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-6">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap text-center">
          <span className="text-[#FF8000] text-sm sm:text-base md:text-lg font-medium font-sans">
            Meet
          </span>
          <Image
            src="/lavaTypo.png"
...
function NumbersSection() {
  const stats = [
    { label: "Creators tracked", value: "100" },
    { label: "Posts pulled today", value: "179" },
    { label: "Viral posts archived", value: "12k" },
    { label: "Templates generated", value: "4.2k" },
  ];
  return (
