...
describe("production-shaped Cowork outcome harness", () => {
  ...
  test("consumes a Trend Radar profile-topic answer instead of asking the same question twice", async () => {
    const sequence = await runCoworkOutcomeSequence([
      {
        id: "trend-radar-profile-topic-question",
        request: {
          message:
      ...
      {
        id: "trend-radar-profile-topic-answer",
        request: {
          message: "Choose a topic from my profile",
